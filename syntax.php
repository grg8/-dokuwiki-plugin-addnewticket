 ...
 */
class syntax_plugin_addnewticket extends DokuWiki_Syntax_Plugin {
    ...
    public function connectTo($mode) {
        $this->Lexer->addSpecialPattern('\{\{NEWDATE[^\}]*\}\}', $mode, 'plugin_addnewticket');
    }
     ...
     *   {{NEWDATE}}
     *   {{NEWDATE>your:namespace}}
     *   {{NEWDATE#newtpl1,newtpl2}}
     *   {{NEWDATE#newtpl1|Title1,newtpl2|Title1}}
     *   {{NEWDATE>your:namespace#newtpl1|Title1,newtpl2|Title1}}
     *
    ...
    public function render($mode, Doku_Renderer $renderer, $data) {
        ...
        if($mode == 'xhtml') {
            ...
            $form = '<div class="addnewticket">' . DOKU_LF
                . DOKU_TAB . '<form name="addnewticket" method="get" action="' . DOKU_BASE . DOKU_SCRIPT . '" accept-charset="' . $lang['encoding'] . '">' . DOKU_LF
